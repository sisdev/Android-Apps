...
public class VideoEnabledWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
    ...
    public static FrameLayout videoViewContainer;
    ...
    {
    	Log.i("ELECT","onShowCustomView(View view, CustomViewCallback callback)full screen");
        if (view instanceof FrameLayout)
        {
        	Log.i("ELECT","onShowCustomView(View view, CustomViewCallback callback)if");
            ...
            {
            	Log.i("ELECT","onShowCustomView(View view, CustomViewCallback callback)else");
    ...
    {
    	Log.i("ELECT","onHideCustomView() full screen");
    ...
    {
    	Log.i("ELECT","onCompletion(MediaPlayer mp)");
        onHideCustomView();
    }
   ...
   // by umesh  
    public void destroyView(){
        	...
        	//usk modification 220
        	Log.i("ELECT","onCompletion(MediaPlayer mp) destroyView");
        	// Call back
            if (videoViewCallback != null) videoViewCallback.onCustomViewHidden();
