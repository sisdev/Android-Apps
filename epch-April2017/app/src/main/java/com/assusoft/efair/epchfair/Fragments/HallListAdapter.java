...
public class HallListAdapter extends BaseAdapter  {
    ...
    public HallListAdapter(Context context, List<String> productList1,EditText searchBoxId) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.productName.setText(productlist.get(position).trim());
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
            	FragmentTransaction ft = ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction();
 		        ...
 		        bundle.putString("HALLNO",productlist.get(position));
    ...
    public void filter(String charText) {
        ...
        else
        {
            ...
            {
                if (product.toLowerCase(Locale.getDefault()).contains(charText))
                {
