...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "com.assusoft.efair.ndwbf2014.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "com.assusoft.efair.ndwbf2014.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "com.assusoft.efair.ndwbf2014.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "com.assusoft.efair.ndwbf2014.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "com.assusoft.efair.ndwbf2014.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "com.assusoft.efair.ndwbf2014.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "com.assusoft.efair.ndwbf2014.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "com.assusoft.efair.ndwbf2014.CATEGORY_LOCATION_SERVICES";

    // Keys for extended data in Intents
    public static final String EXTRA_CONNECTION_CODE =
                    "com.assusoft.efair.ndwbf2014.EXTRA_CONNECTION_CODE";

    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.assusoft.efair.ndwbf2014.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.assusoft.efair.ndwbf2014.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.assusoft.efair.ndwbf2014.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.assusoft.efair.ndwbf2014.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.assusoft.efair.ndwbf2014.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.assusoft.efair.ndwbf2014.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.assusoft.efair.ndwbf2014.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.assusoft.efair.ndwbf2014.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "com.assusoft.efair.ndwbf2014.KEY";
    ...
    //time limit for notification after 10 minute next notification fired.
    public static final long GEO_NOTIFICATION_TIME_LIMIT=10*60*1000;
    public static boolean FIRST_GEO_NOTIFICATION=true;
    public static  long PRE_NOTI_TIME=System.currentTimeMillis();
