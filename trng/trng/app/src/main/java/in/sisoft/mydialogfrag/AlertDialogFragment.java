...
public class AlertDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bb2, container, false);
    }
...
// Inflate the layout for this fragment
        ...
        alb.setTitle("Confirmation Alert");
        alb.setMessage("Please confirm deletion");
        alb.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener()
        {
            @Override
        ...
        alb.setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener()
        {
            @Override
            public void onClick(DialogInterface dialog, int which)
            {
        ...
        android.app.AlertDialog ad = alb.create();
