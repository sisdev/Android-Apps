...
public class FeedbackUserRegistrationFragment extends Fragment implements OnFocusChangeListener{
	Context context;
	String param;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.feedback_user_registration_fragment, container, false);
	    ...
	    protected void onPostExecute(String result) {
	    	...
	    	try {
				...
				if(status.equalsIgnoreCase(WebService.RESPONSE_STATUS_PASS)){
					mySharedPreferences.saveUserRegistrationStatus(WebService.REGISTERED_STATUS_F,REGISTERED_YES);
				    mySharedPreferences.saveUserRegistrationStatus(USER_EMAIL_ID_KEY,userEmailId);
				    mySharedPreferences.saveUserRegistrationStatus(USERNAME,etFname.getText().toString());
				    mySharedPreferences.saveUserRegistrationStatus(CMPNAME,etCompany.getText().toString());
				    mySharedPreferences.saveUserRegistrationStatus(MOBILE,etMobile.getText().toString());
...
/*public class MainRegistrationFragment {
