...
public class ConclaveSecondFragment extends Fragment{
	DatabaseHelper dbHelper;
    ConclaveAdapter adapter;
	Button btnConclaveFirst;
	ListView lvConclave;
	public static String DATE="2014-06-12";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.conclave_second_fragment, container, false);
		
		// Getting reference to the TextView of the Fragment
		btnConclaveFirst= (Button) v.findViewById(R.id.btnConclaveFirst);
     ...
     */
	    ...
	    btnConclaveFirst.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Context fm =(v.getContext());
				HomeActivity.goForEventsDetails=0;
	...
	public void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
//		Commons.getMyTracker(getActivity(), "ConclaveSecondFragment");
	}
	@Override
